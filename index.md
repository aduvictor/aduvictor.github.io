...
<div style="position: relative; width: 100%; text-align: center; color: white;">
  ...
  <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); padding: 20px; background-color: rgba(0, 0, 0, 0.5); max-width: 80%; width: fit-content;">
    ...
    <p>
      ...
      <a href="https://www.uct.ac.za" style="color: #ffffff;">University of Cape Town</a>. 
      My passion lies at the intersection of Controls, Data Analytics, and Aerospace Engineering. 
      I'm currently on the lookout for exciting graduate opportunities in top institutions across the United States.
    </p>
  </div>
</div>
